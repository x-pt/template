...
license_name = ""
license_spdx_id = "" # For Go, this is primarily for README and consistency
license_badge = ""
readme_notice = ""
...
# Go doesn't have a standard license field in go.mod that needs updating by this script.
