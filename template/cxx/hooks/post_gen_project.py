...
license_name = ""
license_spdx_id = "" # Not directly used in C++ project files like CMake/XMake, but good for consistency
license_badge = ""
readme_notice = ""
...
# For C++, check build files for direct references to LICENSE-MIT or LICENSE-APACHE (low probability)
...
#         content = f.read()
#     updated_content = content.replace("LICENSE-MIT", "LICENSE").replace("LICENSE-APACHE", "LICENSE")
#     if updated_content != content:
#         with open(cmake_file_path, "w", encoding='utf-8') as f:
#             f.write(updated_content)
#         print("Updated CMakeLists.txt references to LICENSE.")

# xmake_file_path = os.path.join(project_dir, "xmake.lua")
# if os.path.exists(xmake_file_path):
#     with open(xmake_file_path, "r", encoding='utf-8') as f:
#         content = f.read()
#     updated_content = content.replace("LICENSE-MIT", "LICENSE").replace("LICENSE-APACHE", "LICENSE")
#     if updated_content != content:
#         with open(xmake_file_path, "w", encoding='utf-8') as f:
#             f.write(updated_content)
#         print("Updated xmake.lua references to LICENSE.")
